...
#
# ⚠️ `src/content/` IS counted even though it is prose. On a site, writing a post
# IS the work — excluding it would make the guard silent through exactly the
# sessions this repo exists for.
SUBSTANTIVE = ("src", "tests", "tools", "scripts", "public", ".github",
